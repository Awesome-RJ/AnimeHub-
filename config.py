{
  ...
  "messages": {
    ...
    "download_pagination": "AnimeHub scraped {} episodes for the requested anime (this includes HD, 360p, 480p, 720p and 1080p versions) 😁\n\nFor limiting purposes we only allow displaying of 10 episodes per request 😊",
    "about": "About @Ast_red",
